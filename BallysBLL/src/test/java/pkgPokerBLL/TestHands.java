...
public class TestHands {
	...
	public void TestFlush() {
		...
		//Kickers are the other 4 cards because you keep testing until different
		assertEquals(eRank.KING,h.getHandScore().getKickers().get(0).geteRank());
		assertEquals(eRank.TEN,h.getHandScore().getKickers().get(1).geteRank());
		assertEquals(eRank.EIGHT,h.getHandScore().getKickers().get(2).geteRank());
		assertEquals(eRank.SIX,h.getHandScore().getKickers().get(3).geteRank());
	}
	...
	public void TestThreeOfAKind2() {
		...
		//Other 2 cards are kickers
		assertEquals(eRank.JACK,h.getHandScore().getKickers().get(0).geteRank());
		assertEquals(eRank.TWO,h.getHandScore().getKickers().get(1).geteRank());
	}
	...
	public void TestThreeOfAKind3() {
		...
		//Other 2 cards are kickers
		assertEquals(eRank.SEVEN,h.getHandScore().getKickers().get(0).geteRank());
		assertEquals(eRank.SIX,h.getHandScore().getKickers().get(1).geteRank());
	}
	...
	public void TestPair() {
		...
		assertEquals(eRank.TEN,h.getHandScore().getKickers().get(1).geteRank());
		assertEquals(eRank.FIVE,h.getHandScore().getKickers().get(2).geteRank());
	}
	...
	public void TestPair2() {
		...
		//Kickers are leftover cards
		assertEquals(eRank.EIGHT,h.getHandScore().getKickers().get(0).geteRank());
		assertEquals(eRank.SEVEN,h.getHandScore().getKickers().get(1).geteRank());
		assertEquals(eRank.TWO,h.getHandScore().getKickers().get(2).geteRank());
	}
	...
	public void TestPair3() {
		...
		assertEquals(eRank.THREE,h.getHandScore().getKickers().get(1).geteRank());
		assertEquals(eRank.TWO,h.getHandScore().getKickers().get(2).geteRank());
	}
	...
	public void TestHighCard() {
		...
		//assertEquals(eRank.FOUR,h.getHandScore().getKickers().get(1).geteRank());
		//assertEquals(eRank.THREE,h.getHandScore().getKickers().get(2).geteRank());
		//assertEquals(eRank.TWO,h.getHandScore().getKickers().get(3).geteRank());
	}
}